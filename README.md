...
- Rodando json-server: `$ $ json-server --watch ./src/data/artists.json --port 3000`
...
![Tela](https://github.com/henriquejunqueira/spotify-react-imersao-alura/blob/main/public/spotify.png)
